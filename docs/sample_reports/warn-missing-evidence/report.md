...
## Missing evidence
- api_apply_discount: No direct API test had invalid_discount, 400, and error_status tags. (invalid_discount, 400, error_status)
...
## Decision rationale
- high-risk capability has missing required evidence.
